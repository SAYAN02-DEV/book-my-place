        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-2 mt-2">
              <a href="#" className="text-xs bg-gray-800 px-3 py-2 rounded hover:bg-gray-700">Play Store</a>
              <a href="#" className="text-xs bg-gray-800 px-3 py-2 rounded hover:bg-gray-700">App Store</a>
            </div>
          </div>
        </div>

        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
          <p>&copy; {new Date().getFullYear()} BookMyPlace. All rights reserved.</p>
          <p className="mt-4 md:mt-0">Made with ❤️ for movie lovers</p>
        </div>
      </div>
    </footer>
  );
